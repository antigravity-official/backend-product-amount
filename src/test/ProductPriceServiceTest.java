...
import antigravity.global.PromotionFixture;
...
class ProductPriceServiceTest extends ServiceTestSupport {
    ...
    void createValidProductsAndPromotions() {
        product1 = productService.createProduct(ProductFixture.VALID_PRODUCT1.toEntity()); // 상품 1 -> 158,500 원
        product2 = productService.createProduct(ProductFixture.VALID_PRODUCT2.toEntity()); // 상품 2 -> 178,300 원
        product3 = productService.createProduct(ProductFixture.VALID_PRODUCT3.toEntity()); // 상품 3 -> 353,900 원
        product4 = productService.createProduct(ProductFixture.VALID_PRODUCT4.toEntity()); // 상품 4 -> 464,960 원
        product5 = productService.createProduct(ProductFixture.VALID_PRODUCT5.toEntity()); // 상품 5 -> 720,060 원
        Promotion promotion1 = promotionService.createPromotion(PromotionFixture.VALID_PROMOTION1.toEntity()); // 프로모션 1 -> 30,000원 정액 할인
        Promotion promotion2 = promotionService.createPromotion(PromotionFixture.VALID_PROMOTION2.toEntity()); // 프로모션 2 -> 15% 정률 할인
        Promotion promotion3 = promotionService.createPromotion(PromotionFixture.VALID_PROMOTION3.toEntity()); // 프로모션 3 -> 35% 정률 할인
        Promotion promotion4 = promotionService.createPromotion(PromotionFixture.VALID_PROMOTION4.toEntity()); // 프로모션 4 -> 53,000원 정액 할인
        // 상품 1 -> 프로모션 1 매핑
    ...
    void getValidProductAmount1() {
        ...
        // when
        ProductAmountResponse response = productPriceService.applyDiscount(product1.getId());
        // then
        assertAll(
    ...
    void getValidProductAmount2() {
        // given - @BeforeEach createValidProductsAndPromotions
        // when
        ProductAmountResponse response = productPriceService.applyDiscount(product2.getId());
        // then
        assertAll(
    ...
    void getValidProductAmount3() {
        // given - @BeforeEach createValidProductsAndPromotions
        // when
        ProductAmountResponse response = productPriceService.applyDiscount(product3.getId());
        // then
        assertAll(
    ...
    void getValidProductAmount4() {
        // given - @BeforeEach createValidProductsAndPromotions
        // when
        ProductAmountResponse response = productPriceService.applyDiscount(product4.getId());
        // then
        assertAll(
    ...
    void getValidProductAmount5() {
        // given - @BeforeEach createValidProductsAndPromotions
        // when
        ProductAmountResponse response = productPriceService.applyDiscount(product5.getId());
        // then
        assertAll(
